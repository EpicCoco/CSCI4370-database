...
insert into actor (actorID, fname, lname, age) values ('1', 'Charlie', 'Day', 32);
insert into actor (actorID, fname, lname, age) values ('2', 'Charlie', 'Hunnam', 37);
insert into actor (actorID, fname, lname, age) values ('3', 'Scarlett', 'Johansson', 39);
insert into actor (actorID, fname, lname, age) values ('4', 'Jason', 'Shwartzman', 45);
insert into actor (actorID, fname, lname, age) values ('5', 'Bruce', 'Willis', 50);
insert into actor (actorID, fname, lname, age) values ('6', 'Steve', 'Carell', 47);
insert into actor (actorID, fname, lname, age) values ('7', 'John', 'Leguizamo', 35);
insert into actor (actorID, fname, lname, age) values ('8', 'Chris', 'Wedge', 60);
insert into actor (actorID, fname, lname, age) values ('9', 'Nicole', 'Kidman', 51);
insert into actor (actorID, fname, lname, age) values ('10', 'Alakina', 'Mann', 28);
insert into actor (actorID, fname, lname, age) values ('11', 'Kate', 'Beckinsale', 26);
insert into actor (actorID, fname, lname, age) values ('12', 'Theo', 'James', 31);
insert into actor (actorID, fname, lname, age) values ('13', 'Jeff', 'Bridges', 62);
insert into actor (actorID, fname, lname, age) values ('14', 'Bruce', 'Boxleitner', 65);
insert into actor (actorID, fname, lname, age) values ('15', 'Daniel', 'Kaluuya', 34);
insert into actor (actorID, fname, lname, age) values ('16', 'Allison', 'Williams', 38);
insert into actor (actorID, fname, lname, age) values ('17', 'Zachary', 'Levi', 42);
insert into actor (actorID, fname, lname, age) values ('18', 'Asher', 'Angel', 29);
insert into actor (actorID, fname, lname, age) values ('19', 'Robert', 'Downey', 49);
insert into actor (actorID, fname, lname, age) values ('20', 'Chris', 'Evans', 39);
