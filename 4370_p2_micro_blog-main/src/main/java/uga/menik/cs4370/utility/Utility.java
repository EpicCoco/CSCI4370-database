...
public class Utility {
    ...
    public static List<FollowableUser> createSampleFollowableUserList() {
        ...
        followableUsers.add(new FollowableUser("1", "Jude", "Mullins",
                true, "Mar 07, 2024, 10:54 PM"));
        followableUsers.add(new FollowableUser("2", "Ryan", "Albright",
                false, "Mar 05, 2024, 11:00 AM"));
        followableUsers.add(new FollowableUser("3", "Zach", "Bloodworth",
    ...
    public static List<Post> createSamplePostsListWithoutComments() {
        ...
        postsWithoutComments.add(new Post("1", "Exploring Spring Boot features #crazy #dragon",
                "Mar 07, 2024, 10:54 PM", user1, 10, 4, false, false));
        postsWithoutComments.add(new Post("2", "Introduction to Microservices #dragon",
